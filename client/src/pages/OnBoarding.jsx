        ...
        <form onSubmit={handleSubmit}>
          <section>
            ...
            <div className="multiple-input-container">
              ...
              <input id="year" type="number" name="dob_year" placeholder="YYYY" required={true} value={formData.dob_year} onChange={handleChange} />
            </div>
            ...
            <input id="show-gender" type="checkbox" name="show_gander" onChange={handleChange} checked={formData.show_gender} />
            ...
            <div className="multiply-input-container">
              ...
              <label htmlFor="woman-gender-identity">Woman</label>
              <input id="every-gender-interest" type="radio" name="gender-interest" value={"everyone"} onChange={handleChange} checked={formData.gender_interest === 'everyone'} />
